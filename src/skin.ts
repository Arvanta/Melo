...
const COMPACT_PILL_LIGHT = `<!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div id="melo-player">
  ...
  <div class="player-main">
    ...
    <div class="seek-center">
      ...
      <div class="seek-row">
        <input id="seekBar" type="range" class="seek" min="0" max="100" value="0"/>
      </div>
...
const EMBEDDED_SKINS: Record<string, string> = {
  ...
  "compact-pill-dark.html": COMPACT_PILL_DARK,
  "compact-pill-light": COMPACT_PILL_LIGHT,
  "compact-pill-dark": COMPACT_PILL_DARK,
};
