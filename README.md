...
3. Get the installers:
   - **Releases** → draft release `v0.7.2` (contains `Melo_0.7.2_x64-setup.exe` and the `.msi`) — publish to keep it permanent. Previous tags (`v0.7.1`, `v0.7.0`, `v0.6.1`, `v0.6.0`, `v0.5.2`, …) are left untouched.
