...
Version: **0.7.1 Beta** • License: **GPL-3.0**
...
3. Get the installers:
   - **Releases** → draft release `v0.7.1 Beta` (contains `Melo_0.7.1_x64-setup.exe` and the `.msi`) — publish to keep it permanent. Previous tags (`v0.7.0`, `v0.6.1`, `v0.6.0`, `v0.5.2`, …) are left untouched.
   - **Actions → run → Artifacts → melo-windows** (zip with the same installers).
4. Install `Melo_0.7.1_x64-setup.exe` (installs to standard `C:\Program Files\Melo`).
