...
Version: **0.3 Beta** • License: **GPL-3.0**
...
3. Get the installers:
   - **Releases** → draft release `Melo v0.3.0` (contains `Melo_0.3.0_x64-setup.exe` and the `.msi`) — publish to keep it permanent.
   - **Actions → run → Artifacts → melo-windows** (zip with the same installers).
4. Install `Melo_0.3.0_x64-setup.exe` (installs to standard `C:\Program Files\Melo`).
